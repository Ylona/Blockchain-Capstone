...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(ownerOf(tokenId) != to, "Address alread owns token");
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(getOwner() == msg.sender || isApprovedForAll(msg.sender, ownerOf(tokenId)), "Caller is not approved");
...
contract UnicornERC721Token is ERC721Metadata("unicorn", "UIC", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
